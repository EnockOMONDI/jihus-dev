...
#     receipient_list = models.ForeignKey(
#         ReceipientList,
#         on_delete=models.CASCADE,
#         verbose_name=_('receipient list'),
...
#     update_date = models.DateTimeField(_('update date'), default=timezone.now)
#     recipients_count = models.PositiveIntegerField(default=0)
#     total_delivered_messages= models.PositiveIntegerField(_('total delivered'), default=0, editable=False)
#     english_message = models.TextField()
#     kiswahili_text = models.TextField()

#     class Meta:
#         verbose_name = 'BulkSMS'
#         verbose_name_plural = 'BulkSMSES'
